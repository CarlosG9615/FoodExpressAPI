...
public interface OrderRepository extends JpaRepository<Order,Long> {
    ...
    @Query("""
        ...
        GROUP BY o.id, u.username, r.name
        """)
    Page<OrderSummaryDTO> findAllOrderSummariesPaginated(Pageable pageable);
 ...
 */
    ...
    // Esta implementado en RestaurantRepository
    ...
    // ------------------ de juan -----------
    @Query("""
            SELECT new es.daw.foodexpressapi.dto.report.CustomerTotalDTO(
                u.username,
                SUM(od.subtotal)
            )
            FROM Order o
